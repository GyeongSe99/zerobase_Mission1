...
<table class="tg" width="100%">
    ...
    <tr>
        <td class="tgHead" width="20%">와이파이명</td>
        <td class="tgBodyEven"><%=data.get("WIFINAME")%></td>
    </tr>
    <tr>
        <td class="tgHead" width="20%">등록일자</td>
        <td class="tgBodyEven"><%=data.get("wifi_register_date")%></td>
    </tr>
    <tr>
        <td colspan="2" align="center"><a href="showBookMark.jsp">돌아가기</a> | <button onclick="deleteBookmark('<%= bookmarkID %>')">삭제</button>
    </tr>
    <script>
        function deleteBookmark(bookmarkID) {
            var form = document.createElement("form");
            form.method = "POST";
            form.action = "deleteWifiBookMarkSubmit.jsp";
